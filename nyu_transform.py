...
class rotate_right(object):
    ...
    def __init__(self, diff_angle=0, order=2, reshape=False):
        self.angle = 90
...
class CenterCrop(object):
    ...
    def __call__(self, sample):
        ...
        depth = depth.resize((ow, oh),resample=Image.NEAREST)
